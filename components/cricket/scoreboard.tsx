...
export function ScoreboardTeam({ state }: ScoreboardProps) {
  ...
  return (
    <div 
      className="absolute -top-2 -left-2 pointer-events-auto flex flex-col items-start rounded-md bg-background/95 px-2 py-1.5 backdrop-blur-sm border"
...
export function ScoreboardTarget({ state }: ScoreboardProps) {
  ...
  if (state.currentInnings !== 2 || state.target === null) {
    return (
      <div className="absolute -top-2 -right-2 pointer-events-auto flex flex-col items-end rounded-md bg-background/95 px-2 py-1.5 backdrop-blur-sm border border-cyan-500/60">
  ...
  return (
    <div className="absolute -top-2 -right-2 pointer-events-auto flex flex-col items-end rounded-md bg-background/95 px-2 py-1.5 backdrop-blur-sm border border-amber-500/70">
...
export function ScoreboardBatter({ state }: ScoreboardProps) {
  ...
  return (
    <div 
      className="absolute -bottom-2 -left-2 pointer-events-auto flex flex-col items-start rounded-md bg-background/95 px-2 py-1.5 backdrop-blur-sm border"
      style={{ borderColor: battingColor }}
    >
      {/* Striker */}
...
export function ScoreboardBowler({ state }: ScoreboardProps) {
  ...
  return (
    <div 
      className="absolute -bottom-2 -right-2 pointer-events-auto flex flex-col items-end rounded-md bg-background/95 px-2 py-1.5 backdrop-blur-sm border"
